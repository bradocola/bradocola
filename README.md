# Hi, I'm Omar Nagy Mohammed 👋

I am a **Computer Engineering student** at Cairo University with a passion for building robust systems that bridge the gap between hardware and software. I enjoy solving complex problems, whether it's optimizing latency in embedded systems or architecting full-stack database applications.

### 🛠 Technical Toolkit
*   **Languages:** C++, C, Python, Assembly (x86), JavaScript
*   **Hardware/Embedded:** ESP32, BLE communication, MPU6050, VHDL (FPGA/Processor design)
*   **Web/Data:** SQL, HTML, CSS
*   **Tools:** Git, ModelSim, Excel, Word
...
### 📫 Get In Touch
*   **LinkedIn**: [omar-nagy-work](https://www.linkedin.com/in/omar-nagy-work)
*   **Email**: omar.badran.work@gmail.com
